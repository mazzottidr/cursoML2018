...
Ao observar o gráfico de dispersão da expressão dos genes `X1625045_at` e `X1634772_at`, parece que conseguimos identificar 3 grupos. Vamos rodar o algoritmo K means com 3 clusters, nestes dois genes e ver os resultados:

```{r, eval=F, echo=T}
# Determinar um objeto apenas com os genes X1625045_at e X1634772_at
dados_flies_2genes <- select(dados_flies_5genes, X1625045_at, X1634772_at)
...
ggplot(dados_flies_2genes, aes(x=X1625045_at, y=X1634772_at, shape=Grupos_k3, color=Grupos_k3)) +
        geom_point()
...
# Visualizar os resultados, colorindo os pontos de acordo com os grupos resultantes:
ggplot(dados_flies_2genes, aes(x=X1625045_at, y=X1634772_at, shape=Grupos_k4, color=Grupos_k4)) +
        geom_point()
